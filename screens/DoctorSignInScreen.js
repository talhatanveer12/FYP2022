      ...
      .then((snapshot) => {
        if (snapshot.exists()) {
          snapshot.forEach((child) => {
            ...
            if (child.val().DoctorEmail == `${data.email}`) {
              //   console.log("eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeerrrr");
              //   console.log(child.val().DoctorEmail);
              console.log("eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeerrrr");
              //Home
              global.DoctorName = child.val().DoctorName;
              console.log(global.DoctorName);
              global.DoctorCNIC = child.val().DoctorCNIC;
              global.DoctorAddress = child.val().DoctorAddress;
              global.DoctorPMDC = child.val().PMDC;
              global.DoctorEmail = child.val().DoctorEmail;
              console.log(global.DoctorEmail);
              global.DoctorGender = child.val().Gender;
              global.DoctorProfession = child.val().profession;
              //global.DoctorImageUri = child.val().UserImageUri;
          ...
          console.log(child.val().DoctorCNIC);
